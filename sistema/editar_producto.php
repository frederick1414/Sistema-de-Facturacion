...
*/
   ...
   /*                 if (($nombre_foto != '' && ($_POST['foto_actual'] != 'img_producto.png')) || ($_POST['foto_actual'] != $_POST['foto_remove'])) {
    ...
    if (empty($_REQUEST['id'])) {
        ...
        $result_producto = $query_producto;
        $foto = '';
...
<head>
    ...
    <link rel="stylesheet" href="css/iditar_produco_select.css">
...
<body>
                ...
                <div class="form_register" >
                    ...
                    <div class="card" style="width: 18rem;">
                            ...
                            <input type="hidden"  id="foto_remove" name="foto_romeve" value="<?php echo $data_producto['foto']; ?>">
                                ...
                                <input type="producto" name="producto" id="producto" placeholder="Nombre  del producto" value="<?php echo $data_producto['descripcion']; ?>" >
